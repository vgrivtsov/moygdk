...
class SimpleGalleryIndex(Page):
    ...
    intro_title_color = models.CharField(
        verbose_name=_('Intro title color'),
        max_length=250,
        blank=True,
        help_text=_('Alternative H1 title for the gallery page.')
    )
    ...
    content_panels = Page.content_panels + [
        ...
        FieldPanel('intro_title_color', classname='full title'),
